...
public struct StructuredResult<T, E> where E : class
{
    ...
    private StructuredResult(T data)
    {
        Data = data;
        State = ResultState.Ok;
        Error = default;
    ...
    private StructuredResult(E error)
    {
        Data = default;
    ...
    /// <returns></returns>
    public StructuredResult<T, E> Ok(T data) => new(data);
    ...
    /// <returns></returns>
    public StructuredResult<T, E> Err(E error) => new(error);
